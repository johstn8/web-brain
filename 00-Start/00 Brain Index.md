...
1. Regeln: [[AGENTS]]
2. Minimaler Kontext: [[00-Start/01 Core Rules]]
3. Aufgabenrouting: [[00-Start/02 Routing Map]]
4. Verbindlicher Ablauf: [[00-Start/05 Web Product Workflow]]
5. Website-Auftrag: zuerst `../projekte/<Projektname>/` samt `PROJECT.md` und Pflichtartefakten anlegen, danach die im Auftrag verlangte Anzahl vollständiger Websites mit Unterseiten, hohen Motion-Choreografien, SEO und eigenen Ports bauen. Ohne Angabe im Auftrag genau eine Website, siehe [[00-Start/05 Web Product Workflow#Anzahl der Websites]]
...
- Betrieb: [[60-Operations/Delivery and Local Start]], [[60-Operations/Dependencies and Environments]], [[60-Operations/Observability and Maintenance]]
- Qualität: [[70-QA/Quality Gates]], [[70-QA/Test Matrix]]
- Vorlagen: [[80-Templates/Templates Index]]
- Inspiration und Quellen: [[90-References/Inspiration Catalog]], [[90-References/Reference Research Workflow]], [[90-References/Derived Design Patterns]], [[90-References/Tools and Libraries]], [[90-References/pen.dev Workflow]]
- Wartung: [[98-Maintenance/Coverage and Impact Map]], [[98-Maintenance/Change Log]], [[98-Maintenance/Review Queue]]

## Scope

Das Brain liefert Entscheidungsrahmen, nicht automatisch einen Tech-Stack. Jedes Projekt erzeugt eine eigene Master-Spezifikation, die beauftragte Anzahl vollständiger Websites, Unterseiten-Sitemaps und Nachweisartefakte. Quellen- und Rechtsinformationen werden nach dem Build für die spätere Owner-Einschätzung dokumentiert und verändern den Build nicht.
