...
4. **Konkrete Leitreferenz wählen:** Für jede gebaute Website den [[90-References/Reference Research Workflow]] ausführen und im [[90-References/Website Reference Pool]] beginnen. Bei starker fachlicher Passung genau eine konkrete Live-Seite als Leitreferenz wählen; bei mehreren Websites ist jede Auswahl verschieden. Passung, Übernahmetiefe, konkrete Struktur-/Design-/Motion-Adaptionen und bewusste Abweichungen dokumentieren. Galerie-, Award-, Stilbibliotheks- und Sammlungsseiten sind keine Leitreferenzen. Fehlt eine starke Passung, `Eigenentwurf` begründen und kreativ weiterarbeiten.
5. **Design Contract je Website erzeugen:** Für jede gebaute Website [[20-Design/Design Direction]] getrennt festlegen, die gewählte Leitreferenz übersetzen und einen Leitbenchmark aus [[20-Design/Interface Benchmarks]] wählen. Die Leitreferenz liefert Inspiration und Grundstruktur; Brain, Projektwahrheit, Marke, Inhalte, Accessibility und Technik bleiben verbindlich. H0 gilt immer, Stilprofil, Radius, Rahmen, Flächen, Karten, Kopf-/Fußbereich, Chrome, Zweitschrift und Motion werden je Website entschieden. Existieren ältere Fassungen desselben Betriebs, wird das Übernahmeregister aus [[20-Design/Design Direction#Abstand zu Vorgängerfassungen]] vorher ausgefüllt. **UI UX Pro Max wird je Website getrennt ausgeführt und unter `design-system/<website-slug>/MASTER.md` persistiert**, siehe [[00-Start/04 Plugins and Skills#Auslösebedingung]].
