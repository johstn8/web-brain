...
- Visuelle Änderung an Auftakt, Überschriftenanordnung, Kopfzeile oder Logo-Platzierung: Den Design Contract und das UI-UX-Pro-Max-Artefakt der betroffenen Website, Inhaltsanker, H1-/Kopfzeilengeometrie, Informationsbudget, betroffene Komponenten, ganzseitige Renders, mindestens einen erneuten Durchgang nach [[20-Design/Visual Iteration Loop]] und den Impeccable KI-Detail-Review erneut führen. Ändert sich die Auftaktkomposition selbst, wird das Auftaktfeld neu gebaut, nicht nur die bestehende Fassung korrigiert. Vollständige H1-Lesbarkeit und Beginn der nächsten Nutzerfrage beziehungsweise des ersten Beweises innerhalb der zweiten mobilen Bildschirmhöhe erneut prüfen.
