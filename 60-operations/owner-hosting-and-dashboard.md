...
depends_on:
  ...
  - "[[40-backend-security/authentication-and-accounts.md]]"
...
Eine Website wird nicht durch Sondercode im Dashboard angebunden. Sie liefert zwei versionierte, secret-freie Dateien nach [[80-templates/owner-hosting-website-contract.md]]:
...
Property, Konto, Berechtigung, echter API-Abruf und die davon getrennte Indexierbarkeit werden je Website im [[60-operations/release-readiness-register.md]] geführt. Ein erfolgreicher API-Test schließt einen offenen `noindex`- oder `robots.txt`-Befund nicht.
...
- Produktions-Endpunkt, realer Betreiberzugang, optionaler E-Mail-Versand und Ende-zu-Ende-Nachweis werden je Website im [[60-operations/release-readiness-register.md]] geführt. Sichtbare Übergangshinweise bleiben dort bis zu ihrer Entfernung oder bewussten Owner-Freigabe verortet.
