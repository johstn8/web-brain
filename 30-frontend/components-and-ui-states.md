...
Der Design Contract benennt für jede wichtige Inhaltsart die gewählte Grundform. Bei mehreren Websites muss das Komponentenrepertoire eine Pflichtachse der [[20-design/design-direction.md#Stilabstand bei mehreren Websites|Unterscheidungsmatrix]] sein.
...
- Zähler und vergleichbare Werte nutzen tabellarische Ziffern. Eine Zahl ohne Bezugsgröße ist nach [[20-design/interface-benchmarks.md#B4 Data Product Depth]] keine Aussage.
...
- Die landing-page-spezifische Rolle der Kopfzeile, einschließlich Aufmerksamkeitsverhältnis, steht in [[20-design/landing-page-craft.md#Die Kopfzeile auf der Landing Page]].
