...
Seit 28. Juni 2025 erfasst das BFSG unter anderem Dienstleistungen im elektronischen Geschäftsverkehr; Identifizierung, Authentifizierung, Sicherheit und Zahlung müssen wahrnehmbar, bedienbar, verständlich und robust sein.[^bfsg][^bfsgv] Kleinstunternehmen sind bei Dienstleistungen nach § 3 Abs. 3 BFSG ausgenommen, andere Gesetze oder Verträge können dennoch gelten.[^micro] Für jedes Projekt Scope über [[50-legal/legal-decision-tree.md]] prüfen. Eine Accessibility-Information oder Erklärung ersetzt keine barrierefreie Umsetzung.
