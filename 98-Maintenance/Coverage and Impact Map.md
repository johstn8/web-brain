...
| wo eine Angabe bearbeitet wird: zentral oder auf der Seite | [[60-Operations/Owner Hosting and Dashboard#Bearbeiten: zwei Ansichten, eine Entscheidungsregel|Owner Hosting and Dashboard]] | Owner Hosting Website Contract (`surface`), Master Spec, Content-Schema, Test Matrix, Quality Gates |
| Änderungen unmittelbar auf der Seite (Darstellungsregeln) | [[60-Operations/Owner Hosting and Dashboard#Der Seiteneditor|Owner Hosting and Dashboard]] | Owner Hosting Website Contract, Components and UI States, Test Matrix, Quality Gates |
| was auf keiner Website bearbeitet wird (Kopfzeile, Navigation, Anschrift, Kontaktwege, Rechtstextnamen, Logo) | [[60-Operations/Owner Hosting and Dashboard#Was auf keiner Website bearbeitet wird\|Owner Hosting and Dashboard]] | Owner Hosting Website Contract (`gesperrt`), Components and UI States, Legal Pages, Test Matrix, Quality Gates |
| Copyright-Hinweis in der Fußzeile | [[60-Operations/Owner Hosting and Dashboard#Der Copyright-Hinweis steht immer\|Owner Hosting and Dashboard]] | Owner Hosting Website Contract, Legal Pages, Launch Checklist, Quality Gates |
| Weg zurück: Schritt, Papierkorb, Rollback | [[60-Operations/Owner Hosting and Dashboard#Verlauf und Rückgängig\|Owner Hosting and Dashboard]] | Test Matrix, Quality Gates |
