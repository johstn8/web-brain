...
`Chromium headless -> 1440x1200 -> 20 s Renderbudget; Everest 45 s`

| Datei | statisch | Interaktion | Hinweis |
|---|---|---|---|
| `compute.png` | valid | pending | Hero und Navigation sichtbar |
