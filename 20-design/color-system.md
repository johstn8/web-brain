...
Für Oberflächen mit Daten, Listen, Status und Verwaltung gilt die Verteilung aus [[20-design/interface-benchmarks.md#B1 Soft Neutral Product Console]]: neutrale Fläche, Abgrenzung über Hairline, Farbe fast ausschließlich semantisch, eine einzige dunkle Signalfarbe für den aktiven Zustand, Kategorietöne nur als kleine Icon-Tints. Wo Farbe keine Bedeutung trägt, ist sie grau.
