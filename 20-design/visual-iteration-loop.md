...
impacts:
  ...
  - "[[00-start/04-plugins-and-skills.md]]"
...
> Angrenzende Besitzer bleiben unverändert: [[20-design/landing-page-craft.md]] für den
> Aufbau der Startseite, [[20-design/anti-ai-slop.md]] für den Befundkatalog,
> [[20-design/interface-benchmarks.md]] für H0 und Leitbenchmark, [[70-qa/quality-gates.md]]
> für die Abnahme und [[70-qa/test-matrix.md]] für die Prüfumgebung.
...
dieses Brains erfüllt und jeden Befund aus [[20-design/anti-ai-slop.md#Slop-Signaturen]]
...
Die zweite Lücke liegt davor: Das [[20-design/landing-page-craft.md#Auftakt-Repertoire]]
...
generischen Anmutung, die [[20-design/landing-page-craft.md#Professionell gegen generiert]]
selbst benennt.
...
- Kann in der Umgebung kein echter Render erzeugt werden, ist das nach
  [[70-qa/quality-gates.md]] ein Blocker vor der Lieferung und keine Ausnahme, unter der
  weitergebaut wird.

Der Loop gehört in die Bauphase, nicht in die Abnahme. Er läuft vor dem
KI-Detail-Review aus [[20-design/anti-ai-slop.md#Impeccable KI-Detail-Review]] und ersetzt
...
- Erzeugt wird über ein Browserwerkzeug des Agenten. Fehlt eines, ist das ein
  dokumentierter Blocker nach [[70-qa/quality-gates.md]] und kein Grund, den Loop zu
  überspringen.
...
Website bleibt es nach [[90-references/reference-research-workflow.md]] beim
...
[[20-design/color-system.md#Tokenvertrag]] als **eine gerenderte Seite** ausgegeben und
...
- jede Pflichtfarbrolle als Fläche mit dem Text, der real darauf steht, in Licht und
  Dunkel;
- die Type Ramp aus [[20-design/typography-layout-and-spacing.md]] mit echten
...
- die gewählte Grundform für Inhalte nach
  [[30-frontend/components-and-ui-states.md#Kartenentscheidung]], also Karte, Zeile,
  Tabelle oder Liste, mit Leer- und Ladezustand;
- das Signaturdetail nach [[20-design/landing-page-craft.md#Das Signaturdetail]].
...
- Die Fassungen werden nebeneinander bei 375 und 1280 Pixel angesehen. Gewählt wird
  die, die die drei Zeitfenster aus [[20-design/landing-page-craft.md#Die drei Zeitfenster]]
...
[[00-start/05-web-product-workflow.md#Anzahl der Websites]].** Dort geht es um
...
`prototype` nach [[00-start/04-plugins-and-skills.md#Prototype]]; seine Einsatzgrenze
...
[[30-frontend/components-and-ui-states.md#Kartenentscheidung]]. Verbindlich ist es nur für
den Auftakt.
...
[[00-start/03-update-protocol.md]] als Regel zurückgeführt; der Ort dafür ist
[[20-design/anti-ai-slop.md#Slop-Signaturen]] oder die zuständige Fachnotiz.
...
Dieser Nachweis ersetzt in [[70-qa/quality-gates.md]] den bisherigen passiven Beleg
...
gehört nach [[00-start/04-plugins-and-skills.md]], nicht in diese Notiz.
