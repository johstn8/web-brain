...
Der Aufbau entsteht stattdessen aus der Reihenfolge, in der beim realen Besucher Fragen und Einwände entstehen. Die Grundreihenfolge steht in [[10-strategy/information-density-and-mobile-clarity.md#Eine Frage pro Abschnitt]]. Diese Notiz ergänzt, wie sich die Reihenfolge nach Seitentyp verschiebt und welche Beweisform jeweils zuerst trägt.
...
- Inventar, Muster, Geometrie, Prüfbreiten und das Repertoire möglicher Kopfzeilenformen sind kanonisch in [[30-frontend/components-and-ui-states.md#Kopfzeile und Hauptnavigation]] geregelt.
...
- Spätestens innerhalb der zweiten Bildschirmhöhe beginnt sichtbar die nächste reale Nutzerfrage oder der erste Beweis, siehe [[10-strategy/information-density-and-mobile-clarity.md]].
...
- Die Rangfolge der Beweisformen ist kanonisch in [[10-strategy/content-and-conversion.md#Beweis-Hierarchie]]. Diese Notiz regelt nur ihre Platzierung.
...
Diese Punkte trennen einen sauberen Entwurf von einem fertigen. Sie werden am realen Render geprüft, nicht am Entwurf. Der Arbeitsvorgang dafür — Auftaktfeld, Pflichtdurchgänge, Befundform und Abbruchregel — ist kanonisch in [[20-design/visual-iteration-loop.md]] geregelt; diese Liste ist der Inhalt, den `D2` und `D3` dort abarbeiten.

- Typografischer Feinschliff nach [[20-design/typography-layout-and-spacing.md#Typografischer Feinschliff]]: Zeilenumbruch der H1, Schusterjungen, optischer Randausgleich, Ziffernform, Zeilenlänge.
...
Diese Fragen werden je gebauter Landing Page am laufenden Build beantwortet und ergänzen die Prüffragen aus [[20-design/anti-ai-slop.md#Erkennungsfragen]] und [[10-strategy/information-density-and-mobile-clarity.md#Prüffragen vor der Abnahme]].
...
[^lcp]: [Core Web Vitals: Fix slow hero images](https://www.corewebvitals.io/pagespeed/fix-slow-hero-images-core-web-vitals). Grenzwerte gegen [[30-frontend/performance.md]] halten. Geprüft am 3. September 2026.
