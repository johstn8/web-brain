...
2. Kanonischen Besitzer über [[98-maintenance/coverage-and-impact-map.md]] finden.
...
- Neue oder entfernte Vorschau-Sperre, externe Integration oder produktive Freigabe: [[60-operations/release-readiness-register.md]] jeder betroffenen Website samt Nachweis, Owner und Zielzustand aktualisieren.
...
- Visuelle Änderung an Auftakt, Überschriftenanordnung, Kopfzeile oder Logo-Platzierung: Den Design Contract und das UI-UX-Pro-Max-Artefakt der betroffenen Website, Inhaltsanker, H1-/Kopfzeilengeometrie, Informationsbudget, betroffene Komponenten, ganzseitige Renders, mindestens einen erneuten Durchgang nach [[20-design/visual-iteration-loop.md]] und den Impeccable KI-Detail-Review erneut führen. Ändert sich die Auftaktkomposition selbst, wird das Auftaktfeld neu gebaut, nicht nur die bestehende Fassung korrigiert. Vollständige H1-Lesbarkeit und Beginn der nächsten Nutzerfrage beziehungsweise des ersten Beweises innerhalb der zweiten mobilen Bildschirmhöhe erneut prüfen.
- Owner-editierbarer Inhaltsblock: stabilen JSON-Pointer, `owner_editable`, Typ, Grenzen, Preview-Routen, Veröffentlichungspolicy, Dashboardformular, Servervalidierung, Inhaltsrevisionen und Datenschutzinventar gemeinsam aktualisieren. Bei bestehendem Hosting den Contract-Plan aus [[80-templates/owner-hosting-website-contract.md]] ausführen; Owner-Werte erhalten, explizit migrieren oder dokumentiert archivieren.
