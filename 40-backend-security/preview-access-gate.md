...
- Durchsetzung serverseitig am Reverse Proxy, nicht in der Anwendung. Ein Client-Check ist nach [[40-backend-security/security-baseline.md]] unzulässig, und ein Proxy-Gate schützt zusätzlich statische Dateien und Fehlerseiten.
